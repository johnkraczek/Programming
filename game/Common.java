...
>>>>>>> 1038cc058ca31ac00366ddcd3e8ff75bec5bf1af
	...
	public static final String[] jewelPath = new String[] { "res/Jewel0.png",
			"res/Jewel1.png", "res/Jewel2.png", "res/Jewel3.png",
			"res/jewel4.png", "res/Jewel5.png" };

	public static Image[] jewelType = new Image[Common.jewelTypes];

	static void setJewelType() {
		for (int i = 0; i < jewelTypes; i++) {
			jewelType[i] = new ImageIcon(new ImageIcon(
					Common.class.getResource(jewelPath[i])).getImage()
